package capitulo3;
//Figura 3.9 AccountTest.Java  // Entrada e saída de números de ponto flutuante com objetos Account.
...
public class ModifiedAccountTest 
{
	...
	{
		ModifiedAcount account1= new ModifiedAcount("Jane Green", 50.00);
		ModifiedAcount account2= new ModifiedAcount("John Blue", -7.53);
...
} // fim da classe ModifiedAccountTest