package capitulo4;
// Figura 4.8: ClassAverage.java // Resolvendo o problema da média da classe usando a repetição controlada por contador.
...
public class ClassAverage {
	...
	public static void main(String[] args) 
	{
		...
		while (gradeCounter <= 10) // faz o loop 10 vezes
		{
			...
			gradeCounter = gradeCounter + 1; // incremente o contador por 1
		}
		
		// fase de  término
		int average = total / gradeCounter; // divisão de inteiros produz um resultado inteiro
