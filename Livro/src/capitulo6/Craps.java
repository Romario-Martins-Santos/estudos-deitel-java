// Figura 6.8: Craps.java  // A classe Craps simula o jogo de dados craps.
package capitulo6;
import java.security.SecureRandom;

public class Craps 
{
	// cria um gerador seguro de números aleatórios para uso do método rollDice
	...
	public static void main(String[] args) 
	{
		...
		case YO_LEVEN: // ganha com 11 no primeiro lançamento
			gameStatus = Status.WON; // Atribuindo um dos objetos prontos a classe Status
			break;
