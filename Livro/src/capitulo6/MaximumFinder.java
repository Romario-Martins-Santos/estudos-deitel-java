// Figura 6.3: MaximumFinder.java   // Método maximum declarado pelo  programador com três parâmetros double.
package capitulo6;
...
//			maximumValue = z;
		...
		// As linhas acima poderiam ter sido substituídas chamando o método max da classe Math
